...
void makingBeforeAfterHists()//TString fBasePath)
{
  gStyle->SetOptStat(0);
  ...
  //TFile* f = TFile::Open("/home/dhruv/alice_calib_emcal") 

  
  //......................................................
  //..Get the OADB information
  TString fBasePath="/home/dhruv/alice_calib_emcal";
  
  AliOADBContainer *cont=new AliOADBContainer("");
  cont->InitFromFile(Form("%s/EMCALSingleChannelCalibrations.root",fBasePath.Data()),"AliEMCALSingleChannelCoefficient");
  
  //......................................................
  //..Initialize EMCal/DCal geometry
  vector<int> RunIdVec;
  RunIdVec.push_back(244825);
  ...
  for(Int_t iRun = 0; iRun < nRuns; iRun++)
      ...
      for(Int_t iSM = 0; iSM < nSM; iSM++)
	{
	  ...
	  h[iSM]=(TH2D *)recal->FindObject(Form("EMCALSCCalibMap_Mod%d",iSM));
